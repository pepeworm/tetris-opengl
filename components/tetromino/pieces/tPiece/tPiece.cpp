...
TPiece::TPiece(Renderer* renderer, BoardData* boardData, float startX, float startY) {
...
void TPiece::updatePos(float startX, float startY) {
	...
	this->positions[6] = startX + this->boardData->squareSize;
